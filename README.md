...
3. 변환 옵션 설정 (형식, 페이지 크기, 이미지 포함 여부, 링크 처리 방식)
4. **변환하기** 클릭 후 결과 파일 다운로드
...
| DOCX 생성 | [Apache POI](https://poi.apache.org/) 5.2.5 |
| HTML 파싱 | [Jsoup](https://jsoup.org/) 1.17.2 |
| 웹 프레임워크 | Spring Boot 3.2.5 |
| UI | Bootstrap 5 |
